        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16 md:mb-24">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm">
              ...
              <li><Link to="/private-dining" className="hover:text-[var(--terracotta)] transition-colors">Private Dining</Link></li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm mb-8">
              <li><button onClick={openReservation} className="hover:text-[var(--terracotta)] transition-colors text-left">{t('footer.reserve')}</button></li>
