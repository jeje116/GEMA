        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 items-center mb-32">
          ...
          >
            ...
            <p className="text-[var(--muted)] mb-6 leading-relaxed">
              Born from a desire to bring elevated, authentic Italian dining to Surabaya, GEMA was conceived as more than a restaurant. It is a <em>Societiet</em>—a gathering place for those who appreciate the intersection of culinary tradition and contemporary art.
            </p>
