      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          <ResponsiveImage 
            ...
            className="w-full h-full"
            imgClassName="brightness-[0.6] sepia-[0.1]" // Warm dark overlay for text contrast
          />
        </motion.div>
      </div>
      ...
      <div className="relative z-10 text-center text-[var(--white)] px-4 mt-16 max-w-4xl mx-auto flex flex-col items-center">
        ...
        >
          <button 
            ...
            className="px-8 py-3 bg-[var(--white)] text-[var(--ink)] font-condensed tracking-widest uppercase text-sm hover:bg-[var(--ivory-100)] transition-colors"
          >
