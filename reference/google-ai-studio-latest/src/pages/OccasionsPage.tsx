...
import { occasionCategories, pastBrandEvents } from '../data/occasions';
...
export default function OccasionsPage() {
  ...
  useDocumentMeta({
    ...
    description: 'Private dinings, weddings, birthdays, and exclusive events at GEMA.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
            ...
            >
              ...
              <div className="w-full md:w-1/2">
                ...
                <button 
                  ...
                  className="px-8 py-4 bg-[var(--ink)] text-white font-condensed tracking-widest uppercase text-sm hover:bg-[var(--espresso-800)] transition-colors inline-block"
                >
                  Inquire Now
                </button>
              </div>
        ...
        <div className="border-t border-[var(--ivory-200)] pt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pastBrandEvents.map((event, index) => (
              <motion.div 
                key={event.id}
