          ...
          <div>
            ...
            <div className="flex flex-col gap-8">
              ...
              >
                ...
                <a href={siteData.mapUrl} target="_blank" rel="noopener noreferrer" className="text-sm font-condensed tracking-widest uppercase hover:text-[var(--terracotta)] transition-colors border-b border-[var(--terracotta)] pb-0.5">
                  Open in Google Maps
                </a>
              </motion.div>
            ...
            >
              <button 
                ...
                className="px-8 py-3 bg-[var(--ink)] text-[var(--white)] font-condensed tracking-widest uppercase text-sm hover:bg-[var(--espresso-800)] transition-colors inline-block"
              >
                {t('nav.reserve')}
              </button>
            </motion.div>
